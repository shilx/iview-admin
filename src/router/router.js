...
let menuRouter = [
    ...
    },
    {
        ...
        router: [{
            ...
            component: Main,
            children: [
                { path: 'account', title: '开户审核', name: 'verifyper_account', component: resolve => { require(['@/views/error-page/error-page.vue'], resolve); } },
                { path: 'info', title: '认证审核', name: 'verifyper_info', component: resolve => { require(['@/views/error-page/error-page.vue'], resolve); } }
            ]
        }]
    },
    {
        ...
        router: [{
            ...
            component: Main,
            children: [
                { path: 'account', title: '借款管理', name: 'manage', component: resolve => { require(['@/views/error-page/error-page.vue'], resolve); } },
                { path: 'info', title: '逾期管理', name: 'overdue', component: resolve => { require(['@/views/error-page/error-page.vue'], resolve); } }
            ]
        }]
    },
    {
